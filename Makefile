...
link:
	g++ player.o -o player field.o -o field collectable.o -o collectable enemy.o -o enemy game.o -o game main.o -o main -L src/lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-network -lsfml-audio
